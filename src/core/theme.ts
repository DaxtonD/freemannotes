...
const freemanThemes: ThemeDefinition[] = [
	{
		...
		labelKey: 'theme.freemanBlackMesa',
		variables: {
			'--color-app-bg': '#151917',
			'--color-surface': '#1e241f',
			'--color-surface-2': '#272e2b',
			'--color-border': 'rgba(174, 205, 168, 0.14)',
			'--color-outline': 'rgba(104, 172, 80, 0.58)',
			'--color-text': '#d6e8d2',
			'--color-text-muted': '#96b090',
			'--color-button-bg': '#272e2b',
			'--color-button-text': '#d6e8d2',
			'--color-input-bg': '#0f1210',
			'--color-input-text': '#d6e8d2',
			'--color-accent': '#78b95a',
			'--color-overlay': 'rgba(12, 16, 14, 0.74)',
		},
	},
	{
		id: 'freeman-xen',
		labelKey: 'theme.freemanXen',
		variables: {
			'--color-app-bg': '#0d0c1e',
			'--color-surface': '#15132e',
			'--color-surface-2': '#1e1c42',
			'--color-border': 'rgba(200, 175, 248, 0.14)',
			'--color-outline': 'rgba(152, 90, 220, 0.58)',
			'--color-text': '#e0d4f8',
			'--color-text-muted': '#a885cc',
			'--color-button-bg': '#1e1c42',
			'--color-button-text': '#e0d4f8',
			'--color-input-bg': '#090818',
			'--color-input-text': '#e0d4f8',
			'--color-accent': '#b068e8',
			'--color-overlay': 'rgba(9, 8, 20, 0.78)',
		},
	},
	{
		id: 'freeman-ravenholm',
		labelKey: 'theme.freemanRavenholm',
		variables: {
			'--color-app-bg': '#0f1a10',
			'--color-surface': '#182b1a',
			'--color-surface-2': '#213823',
			'--color-border': 'rgba(184, 210, 176, 0.14)',
			'--color-outline': 'rgba(90, 148, 104, 0.54)',
			'--color-text': '#d8ecda',
			'--color-text-muted': '#b2c0b4',
			'--color-button-bg': '#213823',
			'--color-button-text': '#d8ecda',
			'--color-input-bg': '#0a1209',
			'--color-input-text': '#d8ecda',
			'--color-accent': '#5a9468',
			'--color-overlay': 'rgba(10, 18, 12, 0.75)',
		},
	},
	{
		id: 'freeman-city-17',
		labelKey: 'theme.freemanCity17',
		variables: {
			'--color-app-bg': '#1a2235',
			'--color-surface': '#222f4a',
			'--color-surface-2': '#2d3e60',
			'--color-border': 'rgba(175, 200, 242, 0.15)',
			'--color-outline': 'rgba(74, 158, 255, 0.56)',
			'--color-text': '#cddaf8',
			'--color-text-muted': '#90a8d0',
			'--color-button-bg': '#2d3e60',
			'--color-button-text': '#cddaf8',
			'--color-input-bg': '#131926',
			'--color-input-text': '#cddaf8',
			'--color-accent': '#4a9eff',
			'--color-overlay': 'rgba(18, 26, 46, 0.78)',
		},
	},
	{
		id: 'freeman-the-citadel',
		labelKey: 'theme.freemanTheCitadel',
		variables: {
			'--color-app-bg': '#0c1020',
			'--color-surface': '#141828',
			'--color-surface-2': '#1c2236',
			'--color-border': 'rgba(0, 200, 240, 0.14)',
			'--color-outline': 'rgba(0, 212, 255, 0.52)',
			'--color-text': '#c8e8f8',
			'--color-text-muted': '#7ab8d8',
			'--color-button-bg': '#1c2236',
			'--color-button-text': '#c8e8f8',
			'--color-input-bg': '#07101c',
			'--color-input-text': '#c8e8f8',
			'--color-accent': '#00d4ff',
			'--color-overlay': 'rgba(7, 10, 24, 0.82)',
		},
	},
	{
		id: 'freeman-lambda-core',
		labelKey: 'theme.freemanLambdaCore',
		variables: {
			'--color-app-bg': '#120c1e',
			'--color-surface': '#1e1530',
			'--color-surface-2': '#281e40',
			'--color-border': 'rgba(208, 178, 250, 0.14)',
			'--color-outline': 'rgba(149, 64, 214, 0.58)',
			'--color-text': '#e8d8f8',
			'--color-text-muted': '#b898d8',
			'--color-button-bg': '#281e40',
			'--color-button-text': '#e8d8f8',
			'--color-input-bg': '#0d0816',
			'--color-input-text': '#e8d8f8',
			'--color-accent': '#9540d6',
			'--color-overlay': 'rgba(12, 9, 22, 0.80)',
		},
	},
	{
		id: 'freeman-aperture-mesa',
		labelKey: 'theme.freemanApertureMesa',
		variables: {
			'--color-app-bg': '#e4f0f8',
			'--color-surface': '#f0f8fc',
			'--color-surface-2': '#d2e8f4',
			'--color-border': 'rgba(20, 60, 100, 0.12)',
			'--color-outline': 'rgba(0, 153, 204, 0.48)',
			'--color-text': '#122030',
			'--color-text-muted': '#4a6880',
			'--color-button-bg': '#f0f8fc',
			'--color-button-text': '#122030',
			'--color-input-bg': '#f8fcff',
			'--color-input-text': '#122030',
			'--color-accent': '#0099cc',
			'--color-overlay': 'rgba(20, 48, 80, 0.20)',
		},
	},
	{
		id: 'freeman-g-man',
		labelKey: 'theme.freemanGMan',
		variables: {
			'--color-app-bg': '#28304a',
			'--color-surface': '#343d58',
			'--color-surface-2': '#424e6a',
			'--color-border': 'rgba(188, 210, 240, 0.16)',
			'--color-outline': 'rgba(102, 153, 210, 0.58)',
			'--color-text': '#d4e2f4',
			'--color-text-muted': '#96b0cc',
			'--color-button-bg': '#424e6a',
			'--color-button-text': '#d4e2f4',
			'--color-input-bg': '#1e2438',
			'--color-input-text': '#d4e2f4',
			'--color-accent': '#7aaedd',
			'--color-overlay': 'rgba(28, 34, 56, 0.78)',
		},
	},
	{
		id: 'freeman-hev-suit',
		labelKey: 'theme.freemanHevSuit',
		variables: {
			'--color-app-bg': '#1e1a10',
			'--color-surface': '#2c2618',
			'--color-surface-2': '#3a3220',
			'--color-border': 'rgba(252, 210, 120, 0.14)',
			'--color-outline': 'rgba(255, 159, 10, 0.56)',
			'--color-text': '#f4e8d0',
			'--color-text-muted': '#c8a868',
			'--color-button-bg': '#3a3220',
			'--color-button-text': '#f4e8d0',
			'--color-input-bg': '#14110a',
			'--color-input-text': '#f4e8d0',
			'--color-accent': '#ff9f0a',
			'--color-overlay': 'rgba(18, 14, 8, 0.76)',
		},
	},
	{
		id: 'freeman-combine-soldier',
		labelKey: 'theme.freemanCombineSoldier',
		variables: {
			'--color-app-bg': '#141416',
			'--color-surface': '#1e2024',
			'--color-surface-2': '#282c32',
			'--color-border': 'rgba(200, 212, 220, 0.14)',
			'--color-outline': 'rgba(148, 168, 188, 0.54)',
			'--color-text': '#d2dce4',
			'--color-text-muted': '#8698a8',
			'--color-button-bg': '#282c32',
			'--color-button-text': '#d2dce4',
			'--color-input-bg': '#0e1012',
			'--color-input-text': '#d2dce4',
			'--color-accent': '#94a8bc',
			'--color-overlay': 'rgba(14, 16, 18, 0.80)',
		},
	},
	{
		id: 'freeman-surface-tension',
		labelKey: 'theme.freemanSurfaceTension',
		variables: {
			'--color-app-bg': '#1c2e45',
			'--color-surface': '#253e58',
			'--color-surface-2': '#2f4e6e',
			'--color-border': 'rgba(168, 200, 240, 0.15)',
			'--color-outline': 'rgba(85, 153, 221, 0.56)',
			'--color-text': '#cee2f4',
			'--color-text-muted': '#8ab8d8',
			'--color-button-bg': '#2f4e6e',
			'--color-button-text': '#cee2f4',
			'--color-input-bg': '#131f30',
			'--color-input-text': '#cee2f4',
			'--color-accent': '#5599dd',
			'--color-overlay': 'rgba(16, 24, 38, 0.78)',
		},
	},
	{
		id: 'freeman-forget-about-freeman',
		labelKey: 'theme.freemanForgetAboutFreeman',
		variables: {
			'--color-app-bg': '#1a1212',
			'--color-surface': '#291c1c',
			'--color-surface-2': '#382424',
			'--color-border': 'rgba(218, 158, 148, 0.14)',
			'--color-outline': 'rgba(196, 68, 68, 0.54)',
			'--color-text': '#f0e0dc',
			'--color-text-muted': '#c09090',
			'--color-button-bg': '#382424',
			'--color-button-text': '#f0e0dc',
			'--color-input-bg': '#120d0d',
			'--color-input-text': '#f0e0dc',
			'--color-accent': '#cc4444',
			'--color-overlay': 'rgba(18, 12, 12, 0.78)',
		},
	},
	{
		id: 'freeman-bmrf-lab',
		labelKey: 'theme.freemanBmrfLab',
		variables: {
			'--color-app-bg': '#f0f4f0',
			'--color-surface': '#fafcfa',
			'--color-surface-2': '#e4ece4',
			'--color-border': 'rgba(60, 90, 60, 0.12)',
			'--color-outline': 'rgba(86, 148, 86, 0.48)',
			'--color-text': '#1c2c1c',
			'--color-text-muted': '#4e6a4e',
			'--color-button-bg': '#fafcfa',
			'--color-button-text': '#1c2c1c',
			'--color-input-bg': '#ffffff',
			'--color-input-text': '#1c2c1c',
			'--color-accent': '#568a56',
			'--color-overlay': 'rgba(28, 48, 28, 0.18)',
		},
	},
	{
		id: 'freeman-mesa-sky',
		labelKey: 'theme.freemanMesaSky',
		variables: {
			'--color-app-bg': '#dde8f4',
			'--color-surface': '#edf4fc',
			'--color-surface-2': '#ccdaed',
			'--color-border': 'rgba(50, 80, 140, 0.13)',
			'--color-outline': 'rgba(70, 130, 200, 0.46)',
			'--color-text': '#1a2c44',
			'--color-text-muted': '#4a6888',
			'--color-button-bg': '#edf4fc',
			'--color-button-text': '#1a2c44',
			'--color-input-bg': '#f6faff',
			'--color-input-text': '#1a2c44',
			'--color-accent': '#4682c8',
			'--color-overlay': 'rgba(28, 48, 78, 0.18)',
		},
	},
];
...
const LIGHT_THEME_IDS: ReadonlySet<string> = new Set([
	...
	// Freeman light themes
	'freeman-aperture-mesa',
	'freeman-bmrf-lab',
	'freeman-mesa-sky',
]);
