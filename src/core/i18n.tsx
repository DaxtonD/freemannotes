...
const FALLBACK_MESSAGES: Dictionary = {
	...
	prefs: {
		...
		aboutBodyLine1: 'Freeman Notes exists to prevent small thoughts from becoming resonance cascades.',
		aboutBodyLine2: 'It captures ideas before they scatter, organizes them without Combine interference, and keeps Civil Protection out of your creative process.',
		aboutBodyLine3: 'No manhacks. No surveillance. Just free notes, recorded and remembered on your terms.',
	...
	collections: {
		...
		renameAction: 'Rename',
		deleteAction: 'Delete',
		deleteConfirmPrefix: 'Delete {name}?',
	...
	documents: {
		...
		emptyBody: 'Document attachments will appear here.',
		addButton: 'Document',
		addTitle: 'Add document',
		attachToNote: 'Attach documents to this note',
		...
		queuedBadge: 'Queued',
		failedBadge: 'Failed',
		processing: 'Processing document text…',
		...
		comingSoonBody: 'Document attachments are temporarily disabled.',
	},
	media: {
