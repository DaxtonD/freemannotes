...
Set DATABASE_URL in your container environment:
...
postgresql://user:pass@your-pg-ip:5432/freemannotes?schema=public
...
America/Regina (or your IANA timezone)
...
Push schema without migrations (dev shortcut)
...
Create DB + sync schema (called automatically on npm run dev)
...
Postgres-powered persistent note order & cross-device consiste
